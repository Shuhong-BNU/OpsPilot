...
import type { ChatMemoryMode, ChatMemoryState } from "@opspilot/api-contracts";
  ...
  <form class="chat-composer" @submit.prevent="submit">
    ...
    <div class="chat-composer__row">
      <div class="chat-composer__field">
        <textarea id="chat-message" v-model="content" rows="1" placeholder="向 OpsPilot 描述你正在处理的问题" :disabled="inputDisabled" @keydown="handleKeydown" />

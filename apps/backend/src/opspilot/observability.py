...
_request_id: ContextVar[str | None] = ContextVar("opspilot_request_id", default=None)
_STRUCTURED_HANDLER_NAME = "opspilot_structured_events"
_SENSITIVE_KEYS = {
    "access_token",
    "accesstoken",
    "api_key",
...
def configure_structured_logging() -> None:
    ...
    for name, configured_logger in logger.manager.loggerDict.items():
        if name.startswith("opspilot.") and isinstance(configured_logger, logging.Logger):

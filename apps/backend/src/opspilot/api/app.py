...
from opspilot.aiops import AiopsDiagnosticService, DiagnosisCasePersistor
from opspilot.alerts import (
    ActiveAlert,
    ActiveAlertProvider,
    AlertProviderError,
    build_alertmanager_alert_provider,
)
from opspilot.auth.repositories import UserRecord
from opspilot.auth.service import AuthError, AuthResult, AuthService
from opspilot.auth.sqlite import SQLiteAuthRepository
from opspilot.chat import (
    ChatAgentRunner,
    ChatStreamingService,
    LangChainChatAgentRunner,
    encode_sse,
)
from opspilot.chat.configuration import (
    DEFAULT_CHAT_PROMPT_CONTENT,
    DEFAULT_CHAT_PROMPT_LABEL,
    validate_chat_prompt_content,
    validate_skill_upload,
)
from opspilot.chat.memory import (
    SUPPORTED_CHAT_MEMORY_MODES,
    ChatContextLimitReached,
    ChatMemoryService,
    memory_payload,
)
from opspilot.documents import (
...
from opspilot.error_catalog import ERROR_DEFINITIONS
from opspilot.feedback import FeedbackError, UserFeedbackService
from opspilot.foundation import get_foundation_info
from opspilot.jobs import BackgroundJobContext, BackgroundJobRuntime, JobCancelled
...
from opspilot.mcp_client import LocalMcpClient
from opspilot.mcp_connections import McpConnectionError, McpConnectionService
from opspilot.memory.database import (
    create_memory_engine,
    create_memory_session_factory,
    load_memory_database_settings,
)
from opspilot.memory.repositories import (
...
from opspilot.memory.sqlite import create_sqlite_memory_repositories
...
from opspilot.project_config import project_config_section, required_int, required_str
from opspilot.retrieval import KnowledgeRetrievalTool, RetrievalVectorStore
from opspilot.vector_store import (
...
def create_app(
    *,
    ...
    configure_structured_logging()
    app = FastAPI(title="OpsPilot API", version="1.2.1", lifespan=lifespan)
    app.add_middleware(
        CORSMiddleware,

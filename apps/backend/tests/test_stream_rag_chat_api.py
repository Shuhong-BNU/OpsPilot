...
from opspilot.chat.configuration import SelectedChatSkill, build_chat_system_prompt
from opspilot.chat.streaming import (
...
from opspilot.memory.repositories import ChatMessageRecord, ChatSessionRecord, MemoryRepositories
...
async def test_streaming_chat_emits_sse_events_and_persists_messages(
    ...
    logging.getLogger("opspilot.chat.streaming").disabled = False
    caplog.set_level(logging.INFO, logger="opspilot.chat.streaming")

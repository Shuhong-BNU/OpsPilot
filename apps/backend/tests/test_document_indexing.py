...
from opspilot.documents.indexing import DocumentIndexingService, chunk_document_text
...
from opspilot.vector_store import VectorChunkRecord
...
async def test_document_indexing_service_writes_scoped_chunks_and_marks_success(
    ...
    logging.getLogger("opspilot.documents.indexing").disabled = False
    caplog.set_level(logging.INFO, logger="opspilot.documents.indexing")

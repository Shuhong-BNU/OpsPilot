...
def draw_finale(spec: DiagramSpec) -> str:
    ...
    c.text(800, 640, "整个 OpsPilot 都是同一套 harness 的可编码工作区", 20, 700, t.product)
    cols = 6
    item_w = 216
    gap_x = 16
    left = 124
...
SPECS = (
    ...
    DiagramSpec(
        ...
        6,
        {
            "roof": "桥面：AI 编码循环把需求安全送达可运行 OpsPilot",
            "pillars": [
                ("需求岸", "功能 / 缺陷 / 反馈"),
                ("OpenSpec 桥塔", "目标与验收"),
                ("harness 桥面", "全仓执行"),
    ...
    DiagramSpec(
        ...
        "需求进入仓库控制面，AI 跨层编码，完整 OpsPilot 交付，证据再回到下一轮",
        "finale",
        8,
        {
            "stages": [

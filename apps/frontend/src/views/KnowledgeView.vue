...
import type { DocumentIndexTask, KnowledgeDocument } from "@opspilot/api-contracts";
...
function uploadDocument(file: File, chunking: import("@opspilot/api-contracts").DocumentChunkingConfiguration): void {
